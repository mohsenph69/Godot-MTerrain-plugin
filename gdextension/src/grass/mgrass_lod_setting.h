...
/*
    If one of the color data OR custom data is not euqal to NONE we generate 4 random number for each one
    And the rest of data will be set in MGrass while putting grass on ground
*/
